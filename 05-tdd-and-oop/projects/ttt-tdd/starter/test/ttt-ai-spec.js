...
describe('ComputerPlayer', function () {
  ...
  it('can produce a list of all valid moves that excludes occupied slots', function () {
    ...
    expect(validMoves).to.deep.include({ id: '00', row: 0, col: 0 });
    expect(validMoves).to.deep.include({ id: '01', row: 0, col: 1 });
    expect(validMoves).to.deep.include({ id: '10', row: 1, col: 0 });
    expect(validMoves).to.deep.include({ id: '12', row: 1, col: 2 });
    expect(validMoves).to.deep.include({ id: '21', row: 2, col: 1 });
    expect(validMoves).to.deep.include({ id: '22', row: 2, col: 2 });
  ...
  it('will block traps', function () {
    ...
    expect(smartMove).to.deep.equal({ row: 1, col: 1 });
